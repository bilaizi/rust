package com.android.examples.githubissues.ui;
...
import com.android.examples.githubissues.adapters.DataAdapter;
import com.android.examples.githubissues.entities.Issue;
import com.android.examples.githubissues.viewmodels.ListIssuesViewModel;
...
public class MainActivity extends LifecycleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                        ...
                        if (repo.length() > 0) {
                            ...
                            if (query.length == 2) {
                                ...
                                handleError(new Exception("Error wrong format of input. Required format owner/repository_name"));
                            }
                        } else {
                            handleError(new Exception("Repository name empty. Required format owner/repository_name"));
                        }
                        return true;
                    }
                    return false;
        ...
        mViewModel.getApiResponse().observe(
                this,
                apiResponse -> {
                    if (apiResponse != null) {
